                        ...
                        <form class="contact-form form" id="ajax-contact" method="post" action="assets/s/contact.php">
                            <div class="controls">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="theme-button-dark" data-text="Send Message">Send Message<span></span></button>
                                    </div>
                                    <div class="messages">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                    <div class="contact-widget">
                        <div class="contact-info">
                            ...
                            <p><i class="fa fa-map"></i> Karvon Yuli Street, Avliyo Ota CJR, Yunusabad District, Tashkent Region, Tashkent.</p>
