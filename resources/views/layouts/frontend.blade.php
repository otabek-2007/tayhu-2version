...
<header id="zr-theme-menu" class="zr-theme-menu-header-navber-area">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <a class="navbar-brand js-scroll d-web btn" href="index.html">
    ...
    <nav class="navbar navbar-b navbar-trans navbar-expand-lg" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll d-mobile" href="index.html">
            ...
            <div class="navbar-collapse collapse" id="navbarDefault">
                <ul class="navbar-nav flex-between">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll" href="catalog.html">Catalog</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll" href="projects.html">Projects</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll" href="team.html">Team</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll" href="blogs.html">Blogs</a></li>

                    <li class="nav-item"><a class="nav-link js-scroll" href="contact.html">Contact</a></li>
                    <li class="nav-item"><a class="theme-button-dark" href="contact.html">Get Help<span></span></a>
                    </li>
                </ul>
            </div>
        </div>
